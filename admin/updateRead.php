...
<div class="container-lg">
    <div class="row py-2 bg-light border-bottom">
        <div class="col">
            <h5>
            Окуу жана тушунуу жоопторду ондоо
            </h5>
        </div>
            ...
            <div class="input-group mb-3">
                ...
                <div class="row border m-1">
                    <?php
                        ...
                        $get = $conn -> query("SELECT * FROM test WHERE type=4 and  id_code=$id_code LIMIT 30 ");
                        $i = 0;
                        while ($row = mysqli_fetch_array($get)) { 
                            $i++;
                            $a = ($row["ans"] == "A"?"checked":"");
                            ...
                            $id_type = $row["id_type"];
                            echo '
                            <div class="ansBlock row d-flex align-items-center my-1" title="Окуу жана тушунуу тест №'.$i.'">
