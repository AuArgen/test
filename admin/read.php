...
<div class="container-lg">
    <div class="row py-2 bg-light border-bottom">
        <div class="col">
            <h5>
                Окуу жана тушунуу боюнча тесттер
            </h5>
        </div>
        <div class="col-1 d-flex justify-content-end">
            <a class="" href="theme.php?type=4">Темалар</a>
        </div>
        <div class="col-1 d-flex justify-content-end">
            <a class="" href="addRead.php">Жаны тест</a>
        </div>
    </div>
        ...
        <tbody>
            <?php 
                ...
                while ($row = mysqli_fetch_array($get)) {
                    $id_code = $row["id"];
                    $get2 = $conn -> query("SELECT * FROM test WHERE type=4 and  id_code=$id_code LIMIT 1");
                    ...
                    <tr>
                        ...
                        <td> <a href="updateRead.php?id='.$id_code.'">Ондоо</a></td>
                    </tr>
                    ';
                }
            ?>
